...
![springmvc_lifecycle_03](./images/springmvc_lifecycle_03.png)<br/>
...
# Filter, Interceptor, AOP 언제 사용?

### 1. Filter => 인코딩, XSS(크로스 사이트 스크립팅) 방어 등.
### 2. Intercepter => 로그인 체크, 권한 체크, 프로그램 실행시간 계산 작업, 로그 확인 등.
### 3. AOP => 로깅, 트랜잭션, 에러 처리 등을 비즈니스 단의 메서드에서 좀 더 세밀하게 조정하고 싶을 때 사용.
